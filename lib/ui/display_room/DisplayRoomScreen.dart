...
class DisplayRoomScreen extends StatefulWidget {
  ...
  @override _DisplayRoomScreenState createState() => _DisplayRoomScreenState(_id);
...
class NameDisplayContainer extends Container implements PreferredSizeWidget{
  ...
  NameDisplayContainer({alignment, padding, child}) : super( child : child, alignment : alignment, padding : padding);
